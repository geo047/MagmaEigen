...
StopServer <- function() {
    invisible(.Call('MagmaEigen_StopServer', PACKAGE = 'MagmaEigen'))
}
...
.CleanupSharedMemory <- function() {
    .Call('MagmaEigen_CleanupSharedMemory', PACKAGE = 'MagmaEigen')
}
...
GetServerArgs <- function(matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails) {
    .Call('MagmaEigen_GetServerArgs', PACKAGE = 'MagmaEigen', matrixDimension, withVectors, numGPUsWanted, memName, semName, printDetails)
}
...
#' N.B. The maximum size allowed of the input matrix is goverend by what was provided in the MagmaEigen::RunServer() function. The server 
...
eigen_mgpu <- function(matrix, symmetric = TRUE, only_values = FALSE, overwrite = FALSE, printInfo = FALSE) {
    .Call('MagmaEigen_eigen_mgpu', PACKAGE = 'MagmaEigen', matrix, symmetric, only_values, overwrite, printInfo)
}

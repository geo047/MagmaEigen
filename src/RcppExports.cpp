...
// StopServer
void StopServer();
RcppExport SEXP MagmaEigen_StopServer() {
BEGIN_RCPP
    StopServer();
    return R_NilValue;
END_RCPP
...
RcppExport SEXP MagmaEigen_CleanupSharedMemory() {
BEGIN_RCPP
...
RcppExport SEXP MagmaEigen_GetServerArgs(SEXP matrixDimensionSEXP, SEXP withVectorsSEXP, SEXP numGPUsWantedSEXP, SEXP memNameSEXP, SEXP semNameSEXP, SEXP printDetailsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
...
RcppExport SEXP MagmaEigen_eigen_mgpu(SEXP matrixSEXP, SEXP symmetricSEXP, SEXP only_valuesSEXP, SEXP overwriteSEXP, SEXP printInfoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
